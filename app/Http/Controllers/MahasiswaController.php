...
{
    private $routePrefix = 'adminmahasiswa';
    private $viewIndex = 'mahasiswa_index';
    private $viewCreate  = 'mahasiswa_form';
    private $viewEdit  = 'mahasiswa_form';
     /**
    ...
    public function index()
    {
        return view('admin.' . $this->viewIndex, [
            'models' => Model::where('akses', 'mahasiswa')->get(),
