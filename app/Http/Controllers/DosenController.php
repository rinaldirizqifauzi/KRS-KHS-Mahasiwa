...
{
    private $routePrefix = 'admindosen';
    private $viewIndex = 'dosen_index';
    private $viewCreate  = 'dosen_form';
    private $viewEdit  = 'dosen_form';
     /**
    ...
    public function index()
    {
        ...
        return view('admin.' . $this->viewIndex, [
            'models' => Model::where('akses','dosen')->get(),
            'bread_title1' => 'Dosen',
