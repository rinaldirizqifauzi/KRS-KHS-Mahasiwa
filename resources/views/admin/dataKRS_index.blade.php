                                ...
                                <table class="table table-sm table-bordered table-striped align-items-center justify-content-center mb-0">
                                    <thead style="background-color: black; color: white">
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7" width="1%">Nama Mahasiswa</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xl font-weight-bold mb-0 ps-2">{{ $item->mahasiswa }}</p>
                                            </td>
                                            <td>
                                              <center>
                                                 <div class="d-flex">
