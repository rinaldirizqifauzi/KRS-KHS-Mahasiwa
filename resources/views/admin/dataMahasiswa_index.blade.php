                                ...
                                <table class="table table-sm table-bordered table-striped align-items-center justify-content-center mb-0">
                                    <thead style="background-color: black; color: white">
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-3">Prodi</th>
                                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-3"><center>Matakuliah</center></th>
